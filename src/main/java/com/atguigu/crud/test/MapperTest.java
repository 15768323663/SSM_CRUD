...
public class MapperTest {
	...
	public void testCRUD(){
		...
		//2、从容器中获取mapper
		 DepartmentMapper department = ioc.getBean(DepartmentMapper.class);*/
		...
		//生成员工数据
		//employeeMapper.insertSelective(new Employee(null,"aa","M","aa@atguigu.com",1));
	    
		//3、批量插入多个员工，批量，使用可以批量操作的sqlSession。
		/*for(){
			/employeeMaper.insertSelective(new Employee(null, ,"M","aa@atguigu.com",1));
		}*/
